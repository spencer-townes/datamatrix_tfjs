...
tf.loadGraphModel(
    'https://gitlab.csi.miamioh.edu/2023-capstone/Mobile_Multiple_Simultaneous_Barcodes_Scanning_/mobile-multiple-barcode-scanner-project/-/blob/tensorflow/src/assets/best_web_model/model.json').then(function (loadedModel) {
  model = loadedModel;
